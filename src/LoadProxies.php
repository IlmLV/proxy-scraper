...
class LoadProxies
{
    ...
    private array $scrapers = [
        ...
        Sources\HproxyCom::class,
        Sources\Mmpx12::class,
        Sources\Monosans::class,
        Sources\OpenProxyListXyz::class,

...
use IlmLV\ProxyScraper\Tests\Support\StubJsonScrapper;
use PHPUnit\Framework\TestCase;

class JsonScrapperTest extends TestCase
{
    public function testParsesSingleJsonObject(): void
    {
        $scraper = new StubJsonScrapper(MockClientFactory::fromFixture('Sources/jsonobject.json'));
    ...
    {
        $scraper = new StubJsonScrapper(MockClientFactory::fromString('{"ip":"1.2.3.4"}'));
    ...
    {
        $scraper = new StubJsonScrapper(MockClientFactory::fromString('', 500));
